...
public class Lessons {
    private JSONObject obj_fidels = null;
    ...
    public Lessons(InputStream in_fidels, InputStream in_whole_fidels)
    {
        create_list_lessons(in_fidels);
        create_lessons_fidels(in_whole_fidels); //Get all the values here. And if the user wants everything then return the value.
    }

    /**
     * Create the list of all aphabets.
     * @param in
     * JSON iterator to the file.
     */
     ...
     *
     * @return
     * Just like the above one without the key.
     * [['ha','hu','hi'],['le','lu','li]]
     */
